...
namespace LouLouStarterContent.Editor
{
    ...
    public abstract class BasePropertyDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            //var type = masterObject.GetType();
            //FieldInfo info = null;
            //info = type.GetField(property.propertyPath);
            //fieldInfo.GetValue(property.serializedObject.targetObject);
            //Debug.Log(property.propertyPath +" "+ fieldInfo.FieldType );
            //Debug.Log(EditorExtention.GetValueFromObject(property.serializedObject.targetObject, property.propertyPath));
            //Debug.Log(target);
